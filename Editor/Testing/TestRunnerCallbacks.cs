...
namespace Antigravity.Unity.Editor.Testing
{
    internal class TestRunnerCallbacks : ICallbacks
    {
        ...
        {
            AntigravityIntegration.BroadcastMessage(
                Messaging.MessageType.RunFinished,
                Serialize(testResultAdaptor)
            );
        }
        ...
        {
            AntigravityIntegration.BroadcastMessage(
                Messaging.MessageType.RunStarted,
                Serialize(testAdaptor)
            );
        }
        ...
        {
            AntigravityIntegration.BroadcastMessage(
                Messaging.MessageType.TestFinished,
                Serialize(testResultAdaptor)
            );
        }
        ...
        {
            AntigravityIntegration.BroadcastMessage(
                Messaging.MessageType.TestStarted,
                Serialize(testAdaptor)
            );
        }
