...
namespace Antigravity.Unity.Editor
{
    ...
    public class AssemblyNameProvider : IAssemblyNameProvider
    {
        ...
        > m_PackageInfoCache = new Dictionary<string, UnityEditor.PackageManager.PackageInfo>();
        ...
        internal static readonly string AssemblyOutput =
            @"Temp\bin\Debug\".NormalizePathSeparators();
        internal static readonly string PlayerAssemblyOutput =
            @"Temp\bin\Debug\Player\".NormalizePathSeparators();
