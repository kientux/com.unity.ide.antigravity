...
namespace Antigravity.Unity.Editor
{
    internal class SdkStyleProjectGeneration : ProjectGeneration
    {
        ...
        internal static readonly string[] SupportedCapabilities = new string[] { "Unity" };
        ...
        )
        {
            ...
            headerBuilder
                ...
                .Append(k_WindowsNewline);
            headerBuilder
                .Append(@"    <EnableDefaultItems>false</EnableDefaultItems>")
                .Append(k_WindowsNewline);
            headerBuilder
                .Append(@"    <LangVersion>")
            ...
            headerBuilder.Append(@"  <PropertyGroup>").Append(k_WindowsNewline);
            headerBuilder
                .Append(@"    <NoStandardLibraries>true</NoStandardLibraries>")
                .Append(k_WindowsNewline);
        ...
        internal override string SolutionText(
