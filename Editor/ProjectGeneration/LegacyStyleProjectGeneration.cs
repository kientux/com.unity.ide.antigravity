...
namespace Antigravity.Unity.Editor
{
    internal class LegacyStyleProjectGeneration : ProjectGeneration
    {
        ...
        internal override void GetProjectHeader(
        ...
        )
        {
            ...
            headerBuilder
                .Append(
                    $@"<Project ToolsVersion=""4.0"" DefaultTargets=""Build"" xmlns=""{MSBuildNamespaceUri}"">"
                )
                .Append(k_WindowsNewline);
            headerBuilder
                .Append(
            ...
            headerBuilder
                ...
                .Append(k_WindowsNewline);
            headerBuilder
                .Append(@"    <ProductVersion>10.0.20506</ProductVersion>")
                .Append(k_WindowsNewline);
            headerBuilder
                .Append(@"    <SchemaVersion>2.0</SchemaVersion>")
                .Append(k_WindowsNewline);
            headerBuilder
            ...
            headerBuilder
                ...
                .Append(k_WindowsNewline);
            headerBuilder
                .Append(@"    <FileAlignment>512</FileAlignment>")
                .Append(k_WindowsNewline);
        ...
        internal static void GetProjectHeaderConfigurations(
            ProjectProperties properties,
        ...
        )
        {
            ...
            var referenceName = m_AssemblyNameProvider.GetAssemblyName(
                assembly.outputPath,
                reference.name
            );
